<x-app>
    ...
    <div class="card shadow p-3">
        ...
        <form action="{{ route('slide.update', $slide) }}" method="post" enctype="multipart/form-data" class="form">
            @csrf
            @method('put')
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-3">
                    ...
                    @enderror
                    <img src="{{ asset('storage/' . $slide->image) }}" alt="image" class="w-100 rounded mt-2"
                        id="preview">
                </div>
                ...
                <div class="col-md-9">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('title') is-invalid  @enderror" type="text" id="title"
                            name="title" required value="{{ old('title', $slide->title) }}">
                        @error('title')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid  @enderror" id="description" name="description" required
                            cols="30" rows="2">{{ old('description', $slide->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('button') is-invalid  @enderror" type="text" id="button"
                            name="button" required value="{{ old('button', $slide->button) }}">
                        @error('button')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('link') is-invalid  @enderror" type="text" id="link"
                            name="link" required value="{{ old('link', $slide->link) }}">
                        @error('link')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('order') is-invalid  @enderror" type="text" id="order"
                            name="order" required value="{{ old('order', $slide->order) }}">
                        @error('order')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
